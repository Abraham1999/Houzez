...
namespace houzez_api.Services
{
    public class PropertyService : IPropertyService
    {
        ...
        public PropertyDTO Update(PropertyDTO property)
        {
            ...
            p.Bedrooms = propertyData.Bedrooms;
            p.Bathrooms = propertyData.Bathrooms;
            p.Gardens = propertyData.Gardens;
            p.Price = propertyData.Price;
            p.Status = propertyData.Status;
            p.Image = propertyData.Image;
            p.CreatedAt = propertyData.CreatedAt;
            p.Description = propertyData.Description;
